...
function Login() {
  ...
  return (
    ...
    <div className='flex h-screen  bg-gray-700 text-white items-center justify-center '>
      ...
      {/* email */}
      <form 
       onSubmit={handleSubmit(onSubmit)} className="border border-white px-6 py-2 rounded-md space-y-3 w-96" action="">
...
<div className='flex justify-between'>
    ...
    <button>
        <input  className="bg-orange-950  px-1 py-2 rounded-lg cursor-pointer" type="submit" value={"Login"} />
    </button>
</div>
</form>
    </div>
